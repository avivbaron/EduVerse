...
const file_proto_user_proto_rawDesc = "" +
	...
	"\rValidateToken\x12\x12.user.TokenRequest\x1a\x18.user.ValidationResponseB\x0eZ\fproto/userpbb\x06proto3"
...
var file_proto_user_proto_goTypes = []any{
	...
	(*ValidationResponse)(nil), // 3: user.ValidationResponse
}
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.GetUser:input_type -> user.UserRequest
	2, // 1: user.UserService.ValidateToken:input_type -> user.TokenRequest
	1, // 2: user.UserService.GetUser:output_type -> user.UserResponse
	3, // 3: user.UserService.ValidateToken:output_type -> user.ValidationResponse
