...
type CourseServiceClient interface {
	...
	EnrollUser(ctx context.Context, in *EnrollmentRequest, opts ...grpc.CallOption) (*EnrollmentResponse, error)
}
...
func (c *courseServiceClient) EnrollUser(ctx context.Context, in *EnrollmentRequest, opts ...grpc.CallOption) (*EnrollmentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CourseServiceServer interface {
	...
	EnrollUser(context.Context, *EnrollmentRequest) (*EnrollmentResponse, error)
...
func (UnimplementedCourseServiceServer) EnrollUser(context.Context, *EnrollmentRequest) (*EnrollmentResponse, error) {
...
func _CourseService_EnrollUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseServiceServer).EnrollUser(ctx, req.(*EnrollmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
